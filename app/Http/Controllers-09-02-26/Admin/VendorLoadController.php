...
class VendorLoadController extends Controller
{
   ...
   /* public function reject(Request $request)
    {
        $request->validate([
            'id'      => 'required|exists:load_send_history,id',
        ...
        DB::transaction(function () use ($request) {
            ...
            // make load editable again
           /* LoadSummary::where('id', $send->load_summary_id)
                ->update([
                    'vendor_code' => null,
                    'sent_to_vendor' => 0
                ]);*/
      /*  });
        ...
        return response()->json([
            'status'  => true,
            'message' => 'Load rejected. Admin notified.'
        ]);
    }*/
