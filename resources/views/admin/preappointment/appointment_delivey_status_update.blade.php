...
@section('bodycontent')
 <style>
    ...
    .sticky-col-2 {
      position: sticky;
      left: 65px; /* Adjust based on col-1 width */
      background: #fff;
      z-index: 99;
    }
.sticky-col-3 {
								...
								<table class="table table-bordered border-dark table-hover" id="billDataTable1"  style="table-layout:auto; width:auto;">
								  <thead>
									<tr>
										...
										<th style="background: #fce4d6; color: #0070c0;z-index:999;" class="sticky-col-4">Consignor<br>Name
										</th>
										...
										<th style="background: #fce4d6; color: #0070c0;" class="mobile-hide">Delivery <br>Require date
										</th>
										<th style="background: #fce4d6; color: #0070c0;" class="">Appointment<br>Status
										</th>
										<th style="background: #fce4d6; color: #0070c0;" class="">Remarks
										</th>
										<th style="background: #ddebf7; color: #0070c0;" class="mobile-hide">Delivery Status
										</th>
								  ...
								  <tbody>
									...
									<tr class="{{ in_array($appointdata->id, $mismatchedIds) ? 'table-danger mismatch-row' : '' }}" data-entry-id="{{ $appointdata->id }}"  data-id="{{ $appointdata->id }}">
										...
										<td class="sticky-col-4">{{$appointdata->consignor_name}}</td>
										...
										<td class="">{{$appointdata->appointment_status ?? 'Pending' }}</td>
																				
										<td class="">{{ $appointdata->apptremarks  ?? 'NA'}}</td>
						...
						<table id="billDataTable" class="table table-bordered border-dark table-hover">
						  ...
						  <tbody>
							...
							<tr class="">
								...
								<td class="sticky-col-3">{{$delivered_appointdata->po_no}}</td>								
								<td class="">{{$delivered_appointdata->consignor_name}}</td>
								...
								<td  class="mobile-hide">{{ $delivered_appointdata->appointment_date }}</td>
								<td class="mobile-hide">{{ $delivered_appointdata->appointment_status }}</td>
								<td class="mobile-hide">{{ $delivered_appointdata->apptremarks }}</td>
...
$(document).ready(function(){
    ...
    form.on('submit', function(e){
        ...
        let url = "/admin/preappointments/"+id+"/update-delivery-status";
