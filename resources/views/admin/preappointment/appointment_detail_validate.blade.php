...
.sticky-col-3 {
 ...
 .sticky-col-4 {
      position: sticky;
      left: 410px; /* Adjust based on col-1 width */
      background: #fff;
      z-index: 999;
    }
 .sticky-col-5 {
      position: sticky;
      left: 510px; /* Adjust based on col-1 width */
      background: #fff;
      z-index: 999;
    }
					...
					<div class="table-responsive-fixed border rounded shadow-sm bg-white consign-data-table table-container">
						    <form method="POST" action="{{ route('admin.freight.store') }}" id="freightValidationForm">
								...
								<table class="table table-bordered border-dark table-hover" id="table">
								  <thead>
									<tr>
										<th style="background: #fce4d6; color: #0070c0;z-index:999;" class="sticky-col-1 col-width">S5 consignor short<br> name & location</th>
										<th style="background: #fce4d6; color: #0070c0;z-index:999;" class="sticky-col-2 col-width">D5 consignor short<br> name & location</th>
										<th style="background: #fce4d6; color: #0070c0;z-index:999;" class="sticky-col-3 col-width">Order Ref No.<br />( <small>Indent ID</small>)
										</th>
										<th style="background: #fce4d6; color: #0070c0;z-index:999;" class="sticky-col-4 col-width">Vendor name</th>	
																  
										<th style="background: #fce4d6; color: #0070c0;z-index:999;" class="sticky-col-5 col-width">LR/CN No.</th>
										<th style="background: #fce4d6; color: #0070c0;" class="col-width">LR/CN Date</th>
										<th style="background: #fce4d6; color: #0070c0;" class="col-width">Charged<br /><small>Truck Type</small></th>
										<th style="background: #fce4d6; color: #0070c0;" class="col-width">Ref 1<br />FPO NO.</th>
										...
										<th style="background: #ddebf7; color: #0070c0;" class="col-width">Validate<br>
										<input type="checkbox" id="selectAllValidate"></th> 
										
										<th style="background: #fce4d6; color: #0070c0;" class="col-width">Submit<br>
										<input type="checkbox" id="selectAllSubmit"></th>
										
										<th style="background: #fce4d6; color: #0070c0;" class="col-width">Return<br>
										<input type="checkbox" id="selectAllReturn"></th>

										<th style="background: #fce4d6; color: #0070c0;" class="col-width">Status</th>
								  ...
								  <tbody>
									...
									<tr data-id="{{ $billdata->id }}">
										<td class="sticky-col-1 col-width">{{$billdata->s5_consignor_short_name_and_location}}</td>
										<td class="sticky-col-2 col-width">{{$billdata->d5_consignor_short_name_and_location}}</td>
										<td class="sticky-col-3 col-width">{{$billdata->ref1}}</td>
										<td class="sticky-col-4 col-width">{{$billdata->vendor_name}}</td>
										
										<td class="sticky-col-5 col-width">{{$billdata->lr_no}}</td>
                  ...
                  <div class="tab-pane" id="timeline">
                    <!-- The timeline -->
                  	...
                  	<div class="table-responsive-fixed border rounded shadow-sm bg-white consign-data-table">
						...
						<tr>
							<td class="sticky-col-1 col-width">{{$updatedbilldata->s5_consignor_short_name_and_location}}</td>
							<td class="sticky-col-2 col-width">{{$updatedbilldata->d5_consignor_short_name_and_location}}</td>
							<td class="sticky-col-3 col-width">{{$updatedbilldata->ref1}}</td>
							<td class="sticky-col-4 col-width">{{$updatedbilldata->vendor_name}}</td>
							
							<td class="sticky-col-5 col-width">{{$updatedbilldata->lr_no}}</td>
							...
							<td>{{$updatedbilldata->validation_remark}}</td>
								{{--<td>{{$updatedbilldata->custom}}</td>
							<td>{{$updatedbilldata->custom1}}</td>
							<td>{{$updatedbilldata->custom2}}</td>
							<td>{{$updatedbilldata->custom3}}</td>--}}
