            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
				  ...
				  <li class="nav-item"><a class="nav-link" href="{{ route('admin.loadsummary_auto_allocation') }}">Vendor Allocation</a></li>
							...
							<tr>
								...
								<td>
									<select class="placement-status"
										data-load="{{ $row->id }}"  data-last-status="{{ $row->latestPlacement->placement_status ?? '' }}">
								...
								<td><button class="btn btn-success btn-sm submit-placement"    data-load-id="{{ $row->id }}">Submit</button>
