		 ...
		 <div class="row">          	  
            ...
            <div class="card">
              <div class="card-header p-2">
				...
				<li class="nav-item"><a class="nav-link active" href="{{route('admin.loadSummaryApproval')}}">Approve / Reject Summary</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<button class="btn btn-success" onclick="updateStatus({{ $row->id }}, 'APPROVED')">Approve</button>

									<button class="btn btn-danger" onclick="updateStatus({{ $row->id }}, 'REJECTED')">Reject</button>
