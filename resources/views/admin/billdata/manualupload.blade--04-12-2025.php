			...
			<form action="{{url('/admin/billdata/save_manual_upload')}}" method="post" name="addfrm">
			  ...
			  <div class="table-responsive-fixed border rounded shadow-sm bg-white consign-data-table table-container">
				<table class="table table-bordered border-dark table-hover" id="table">
				  <thead>
					<tr>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Consignor name</th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Consignor code</th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Consignor location</th>
						{{--	<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">S5 consignor <br>short name & location</th>--}}

						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Consignee Name</th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Consignee Code</th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Consignee Location</th>
						{{--<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">D5 consignor short <br>name & location</th>--}}
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Ref1</th>
						
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Vendor Code</th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Vendor Name</th>
						<th style="background: #ddebf7; color: #0070c0;width: 40px" class="col-width">T code</th> 
						<th style="background: #ddebf7; color: #0070c0;width: 140px" class="col-width">Truck type</th> 
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">LR No.</th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">LR CN Date</th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">A amount </th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Ref2</th>
						<th style="background: #fce4d6; color: #0070c0;width: 140px" class="col-width">Ref3</th>
						<th style="background: #c6e0b4; color: #0070c0;width: 140px" class="col-width">Freight type</th>
						<th style="background: #c6e0b4; color: #0070c0;width: 140px" class="col-width">Ap status</th>
						<th style="background: #c6e0b4; color: #0070c0;width: 140px" class="col-width">Custom</th>
