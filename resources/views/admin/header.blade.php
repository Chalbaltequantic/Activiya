            ...
            <ul class="navbar-nav">
              @if(Auth::user() && Auth::user()->role_id ==24)
				...
				<li class="nav-item dropdown">
					...
					@if(Gate::allows('admin.mapping'))
						<li class="{{ request()->is('admin/employeemapping*') ? 'active' : '' }}"  style="z-index:1100;"><a href="{{ route('admin.employeemapping') }}" class="dropdown-item">Upload Employee Mapping</a></li>
					@endif
					@if(Gate::allows('admin.mapping'))
						<li class="{{ request()->is('admin/employeemapping*') ? 'active' : '' }}"  style="z-index:1100;"><a href="{{ route('admin.employeemappingdatalist') }}" class="dropdown-item">View Employee Mapping</a></li>
					@endif
				...
				@if(Gate::allows('admin.lot') || Gate::allows('admin.allocation') || Gate::allows('admin.autoindentallocation') || Gate::allows('admin.approve_llocation') || Gate::allows('admin.V_Indent') || Gate::allows('admin.approve_indent') || Gate::allows('admin.V_Placement_Status') || Gate::allows('admin.Track_Placement_Status') || Gate::allows('admin.Manual_Indent'))	
				 ...
				 <li class="nav-item dropdown">
					<a id="dropdownSubMenu4" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">LOT</a>
					...
					@if(Gate::allows('admin.approve_llocation'))
					  <li class=""><a href="{{route('admin.loadSummaryApproval')}}" class="dropdown-item">Approve Allocation</a></li>	
					@endif
					@if(Gate::allows('admin.V_Indent'))
						<li class=""><a href="{{ route('admin.vendor.loads') }}" class="dropdown-item"> V_Indent</a></li>
					@endif
					@if(Gate::allows('admin.approve_indent'))	
						<li class=""><a href="{{ route('admin.loadsummary.allocation.send') }}" class="dropdown-item">Approve Indent</a></li>
					@endif
					...
					@if(Gate::allows('admin.Manual_Indent'))
						<li class=""><a href="{{ route('admin.manualloadSummarydatalist') }}" class="dropdown-item">Manual Indent</a></li>
					@endif	
