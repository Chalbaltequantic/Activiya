        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="{{url('admin/appointmant')}}" class="btn btn-info">View Appointment data</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
			...
			<form action="{{ route('admin.save_manual') }}" method="post" name="addfrm">
              @csrf
				...
				<table class="table table-bordered border-dark table-hover" id="table">
				  <thead>
					<tr>
						...
						<th style="background: #fce4d6; color: #0070c0;" class="sticky-col-1 col-width">Inv Number</th>
						  <th style="background: #fce4d6; color: #0070c0;" class="sticky-col-2 col-width">Inv Doc Date</th>
						  <th style="background: #fce4d6; color: #0070c0;">LR No</th>
						  <th style="background: #fce4d6; color: #0070c0;" class="col-width">LR Date</th>						  
