      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card-body">
			<form action="{{ url('/admin/appointment/updateappointmentdata') }}" method="post" name="addfrm" enctype="multipart/form-data">
              @csrf
			  <div class="row">
              ...
              <div class="form-group col-md-4">
			   ...
			   <div class="form-group col-md-">
                ...
                <input type="text" id="lr_no" name="lr_no" class="form-control" value="{{$appointmentdata->lr_no}}">
				@error('lr_no')
				<span class="text-danger">{{$message}}</span>
				@enderror
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" id="lr_date" name="lr_date" class="form-control" value="{{$appointmentdata->lr_date}}">
				@error('lr_date')
				<span class="text-danger">{{$message}}</span>
				@enderror
              </div>
		...
		<div class="form-group col-md-4">
		  ...
		  <div class="form-group col-md-4">
                ...
                <input type="text" id="t_code" name="t_code" class="form-control" value="{{$appointmentdata->t_code}}">
                @error('t_code')
                <span class="text-danger">{{$message}}</span>
                @enderror
          </div>
			 <div class="form-group col-md-4">
                ...
                <input type="text" id="truck_type" name="truck_type" class="form-control" value="{{$appointmentdata->truck_type}}">
                @error('truck_type')
                <span class="text-danger">{{$message}}</span>
                @enderror
          </div>	
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" id="vehicle_no" name="vehicle_no" class="form-control" value="{{$appointmentdata->vehicle_no}}">
                @error('vehicle_no')
                <span class="text-danger">{{$message}}</span>
                @enderror
          </div>
