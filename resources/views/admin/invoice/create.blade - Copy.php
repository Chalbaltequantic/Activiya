			...
			<div class="row">	
			 <div class="form-group col-md-4">
			  ...
			  <div class="form-group col-md-4">
                ...
                <input type="text" name="indent_id" value="" class="form-control">
			  ...
			  <div class="form-group col-md-4">
                <label for="gr_charges">GR Charges</label>
                <input type="text" name="gr_charges" value="" class="form-control">
				...
				{{--<div id="items">--}}
						<div class="form-group col-md-4">
						  ...
						  <div class="form-group col-md-4">
						   ...
						   <input type="date" name="items[0][truck_type]" class="form-control">
						  </div>
			...
			<div class="card card-warning">
				...
				{{--<div id="itemsannexure">--}}
						...
						<div class="form-group col-md-4">
						  ...
						  <div class="form-group col-md-4">
							<label for="Description">OBD No / Po No</label>
						   <input type="text" name="annexures[0][obd_no]" class="form-control">
						  </div>
						   <div class="form-group col-md-4">
							<label for="loading_point_0">Loading Point</label>
						   <input type="text" name="annexures[0][loading_point]" class="form-control">
						  </div>
						  <div class="form-group col-md-4">
							<label for="dispatch_date_0">Arrival Date</label>
						   <input type="date" name="annexures[0][arrival_date]" class="form-control">
						  </div>
						   <div class="form-group col-md-4">
							<label for="dispatch_date_0">Dispatch Date</label>
						   <input type="date" name="annexures[0][dispatch_date]" class="form-control">
						  </div>
						  <div class="form-group col-md-4">
							<label for="detention_days_0">Detention Days</label>
						   <input type="date" name="annexures[0][detention_days]" class="form-control">
						  </div>
						   <div class="form-group col-md-4">
